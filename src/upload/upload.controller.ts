...
export class UploadController {
  ...
  async upload(@UploadedFile() file: Express.Multer.File, @Body("category") category: string) {
    ...
    return this.cloudinary.uploadBuffer(file.buffer, cat, file.originalname, file.mimetype);
  }
}
